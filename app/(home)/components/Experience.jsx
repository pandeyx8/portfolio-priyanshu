                                ...
                                >
                                    <div className="flex gap-6">
                                        ...
                                        <div className="flex-1 pb-8">
                                            <div className="bg-black border border-white/30 rounded-2xl p-6 backdrop-blur-md shadow-[0_4px_6px_rgba(0,0,0,0.5),0_0_10px_rgba(255,255,255,0.05),0_0_20px_rgba(59,130,246,0.1)] hover:border-white/60 transition-all duration-300 group relative overflow-hidden hover:shadow-[0_4px_6px_rgba(0,0,0,0.5),0_0_20px_rgba(255,255,255,0.1),0_0_30px_rgba(59,130,246,0.15)]">
                                                {/* Inner glow background */}
                                                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-transparent opacity-30 group-hover:opacity-60 transition-opacity duration-300 pointer-events-none" />
