                                                ...
                                                <div className="flex items-start justify-between gap-2">
                                                    <div className="flex items-center space-x-2 flex-1 min-w-0">
                                                        {project.image ? (
                                                            ...
                                                            <div className="w-6 h-6 rounded-md border border-white/20 bg-white/5 flex items-center justify-center flex-shrink-0">
                                                                <FaGithub className="w-3.5 h-3.5 text-white/80" />
                                                            </div>
                                                        )}
